...
class BlogCategory extends \yii\db\ActiveRecord
{
    ...
    {
        self::$upload_url = str_replace('/backend', '', Yii::getAlias('@web')) . '/uploads/eg-blog/blog-category/';
        self::$upload_path = str_replace('/backend', '', Yii::getAlias('@webroot')) . '/uploads/eg-blog/blog-category/';
        parent::init();
    }
